...
const PortfolioPage = () => {
  return ( <div style={{ backgroundImage: `url(${bgWhite})` }} className="bg-cover bg-center shadow-sm h-screen">
            <div className="fixed top-0 left-0 right-0 z-50 flex justify-center items-center bg-white">
            
            <MainNav />
            <div  className=" hidden lg:flex absolute left-[98%] -translate-x-full">
              <Button asChild className="mr-3"><a href=""><Github />Mon Github </a></Button>
              <Button asChild variant="ghost"><a href=""><Linkedin  />Linkdin</a></Button>
